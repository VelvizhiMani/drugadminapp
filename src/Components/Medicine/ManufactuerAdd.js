...
class ManufactuerAdd extends React.Component {
    constructor(props) {
        super(props);
      ...
      onSubmit(e) {
        ...
        axios.post('http://13.232.195.17:4000/manufactuer', obj)
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    onChange={this.onChangeManufurl}
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    onChange={this.onChangeManufaddress}
