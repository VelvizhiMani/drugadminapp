...
class GenericAdd extends React.Component {
    constructor(props) {
      ...
      onSubmit(e) {
        ...
        axios.post('http://13.232.195.17:4000/generic', formData)
      ...
      componentDidMount() {
        axios.get('http://13.232.195.17:4000/category/')
          .then(response => {
            this.setState({
          ...
          axios.get('http://13.232.195.17:4000/subcategory/')
          .then(response => {
            this.setState({
                                ...
                                <div class="box box-primary">
                                    ...
                                    <form onSubmit={this.onSubmit}>
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="Categoryname">Generic Name</label>
                                                    <input type="category" class="form-control"placeholder="Category Name" onChange={this.onChangeGenericName}/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="Url">URL</label>
                                                    <input type="text" class="form-control" placeholder="URL" onChange={this.onChangeUrl}/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Image Alt Tag" onChange={this.onChangeImagealt}/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Vedio Alt" onChange={this.onChangeVedioalt}/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor9" name="faqs" rows="10" cols="80" onChange={this.onChangeFaqs}></textarea>sideeffects
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor14" name="heartdisease" rows="10" cols="80" onChange={this.onChangeHeartdisease}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Asthma :</label><br></br>
                                                    <textarea id="editor15" name="asthma" rows="10" cols="80" onChange={this.onChangeAsthma}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor17" name="adult" rows="10" cols="80" onChange={this.onChangeAdult}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Use of Medicine in children :</label><br></br>
                                                    <textarea id="editor18" name="usechildren" rows="10" cols="80" onChange={this.onChangeChildrenmed}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Use of Medicine in Elderly Patients:</label>
                                                <textarea id="editor19" name="usepatient" rows="10" cols="80" onChange={this.onChangeElderlymed}></textarea>
                                            </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Alcohol :</label><br></br>
                                                    <textarea id="editor20" name="alcohol" rows="10" cols="80" onChange={this.onChangeAlcohol}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Driving or operating machinery :</label><br></br>
                                                    <textarea id="editor21" name="operatingmach" rows="10" cols="80" onChange={this.onChangeDriving}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Other general warnings :</label><br></br>
                                                    <textarea id="editor22" name="generalwarning" rows="10" cols="80" onChange={this.onChangeWarnings}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Talk to your doctor if :</label><br></br>
                                                    <textarea id="editor23" name="talkdoctor" rows="10" cols="80" onChange={this.onChangeTalkdoctor}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>General instructions :</label><br></br>
                                                    <textarea id="editor24" name="generalins" rows="10" cols="80" onChange={this.onChangeInstructions}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor25" name="interaction" rows="10" cols="80" onChange={this.onChangeDruginteraction}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Drug-Food interaction of Medicine:</label><br></br>
                                                    <textarea id="editor26" name="drugfood" rows="10" cols="80" onChange={this.onChangeDrugfood}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Drug-Disease interaction of Medicine :</label><br></br>
                                                    <textarea id="editor27" name="drugdiease" rows="10" cols="80" onChange={this.onChangeDrugdiease}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Interaction with food items :</label><br></br>
                                                    <textarea id="editor28" name="fooditems" rows="10" cols="80" onChange={this.onChangeFooditems}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor29" name="overdose" rows="10" cols="80" onChange={this.onChangeOverdose}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Missed Dose :</label><br></br>
                                                    <textarea id="editor30" name="missesdose" rows="10" cols="80" onChange={this.onChangeMissesdose}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Storage and disposal :</label><br></br>
                                                    <textarea id="editor31" name="disposal" rows="10" cols="80" onChange={this.onChangeDisposal}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Fast tag :</label><br></br>
                                                    <textarea id="editor32" name="fasttag" rows="10" cols="80" onChange={this.onChangeFasttag}></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>References :</label><br></br>
                                                    <textarea id="editor33" name="references" rows="10" cols="80" onChange={this.onChangeReferences}></textarea>
                                                </div>
                                            </div>
