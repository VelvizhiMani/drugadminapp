...
class ReviewedEdit extends React.Component {
    constructor(props) {
        super(props);
      ...
      componentDidMount() {
        axios.get('http://13.232.195.17:4000/reviewedby/'+this.props.match.params.id)
            .then(response => {
                this.setState({ 
      ...
      onSubmit(e) {
        ...
        axios.patch('http://13.232.195.17:4000/reviewedby/'+ this.props.match.params.id, formData)
            .then(res => console.log(res.data));
        
      // Redirect to Student List 
      this.props.history.push('/reviewedlist')
                            ...
                            <div class="col-md-12">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        ...
                                        <div class="col-md-6">
                                            <Link to="/reviewedlist">
                                                <button type="button" class="btn btn-primary pull-right">
                                                    <i class="fa fa-plus"></i> &nbsp; Reviewed By List</button></Link>
                                        </div>
                                    </div>
                                    {/* role="form" */}
